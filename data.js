...
export const anatomyData = [
    { id: 'esqueletico', title: 'Sistema Esquelético', content: '<div class="card-prose"><p class="mb-4"><strong>Visão MTC:</strong> Governado pelo <strong>Rim</strong>, que armazena a Essência (<span class="tooltip-term" data-term="jing" tabindex="0">Jing</span>). O Jing produz a Medula, que preenche os ossos, a medula espinhal e o cérebro. A força dos ossos, a saúde dos dentes (considerados "o excedente dos ossos") e a função cerebral dependem da força do Jing do Rim. Osteoporose ou problemas dentários crónicos podem indicar uma deficiência do Jing do Rim.</p><h4 class="font-bold text-lg mb-2">Componentes Chave</h4><ul class="list-disc list-inside text-sm"><li><strong>Ossos:</strong> Estrutura e suporte, governados pelo Rim.</li><li><strong>Medula Óssea:</strong> Produz Sangue (<span class="tooltip-term" data-term="xue" tabindex="0">Xue</span>) e está ligada ao Jing.</li><li><strong>Articulações:</strong> A sua flexibilidade depende da nutrição pelo Sangue do Fígado.</li></ul></div>' },
    { id: 'muscular', title: 'Sistema Muscular', content: '<div class="card-prose"><p class="mb-4"><strong>Visão MTC:</strong> A MTC distingue entre Músculos e Tendões. Os <strong>Músculos</strong> são governados pelo <strong>Baço</strong>, que transforma os alimentos em Qi e Sangue para os nutrir. Músculos fracos ou fatigados podem indicar uma deficiência de Qi do Baço. Os <strong>Tendões</strong> são governados pelo <strong>Fígado</strong>, que os humedece com Sangue para garantir flexibilidade e movimento suave. Cãibras, espasmos ou rigidez podem indicar uma deficiência de Sangue no Fígado.</p><h4 class="font-bold text-lg mb-2">Componentes Chave</h4><ul class="list-disc list-inside text-sm"><li><strong>Músculos (Carne):</strong> Governados pelo Baço.</li><li><strong>Tendões e Ligamentos:</strong> Governados pelo Fígado.</li></ul></div>' },
